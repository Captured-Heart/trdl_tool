                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      ...
                      BodyText(
                        indents: 1,
                        text: '- Opheffen en inleggen van bijzonderheden_trein;',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 1,
                      ...
                      BodyText(
                        indents: 1,
                        text: '- Wijzigingen in de volgorde van bijzonderheden_trein.',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                        ...
                        children: const [
                          ...
                          TableRow(
                            children: [
                              ...
                              TableText(text: 'Plaatsbepaling, toestand materieel, toestand infra'),
                            ],
                          ),
                          TableRow(
                            children: [
                          ...
                          TableRow(
                            children: [
                              TableText(text: 'Veiligheidsverantwoordelijke buiten'),
                              TableText(text: 'Functioneren van de infra'),
                            ],
                          ),
                          TableRow(
                            children: [
                              ...
                              TableText(text: 'Beperkingen bij hervatten van de treindienst'),
                            ],
                          ),
                          TableRow(
                            children: [
                              TableText(text: 'Medewerker BackOffice (MKS-BO)'),
                              TableText(text: 'Gegevens van hulpverlenende instanties'),
                            ],
                          ),
                          TableRow(
                            children: [
                          ...
                          TableRow(
                            children: [
                              TableText(text: 'Medewerker Werkplekbeveiliging (WPB)'),
                              TableText(text: 'Aanpassen veiligheidsmaatregelen WBI'),
                            ],
                          ),
                          TableRow(
                            children: [
                              TableText(text: 'Inspecteur Inspectie Leefomgeving & Transport (IL&T)'),
                              TableText(text: 'Plaatsbepaling, inspectie materieel of infra'),
                            ],
                          ),
                        ],
                      ),
                      ...
                      Table(
                        ...
                        children: const [
                          ...
                          TableRow(
                            children: [
                              TableText(text: 'Over'),
                              TableText(text: 'Term om de andere partij het woord te geven'),
                            ],
                          ),
                          TableRow(
                            children: [
                              TableText(text: 'Ontvangen'),
                              TableText(text: 'Term om aan te geven dat het bericht is ontvangen'),
                            ],
                          ),
                          TableRow(
                            children: [
                              TableText(text: 'Herhaal bericht'),
                              TableText(text: 'Uitdrukking om aan te geven dat het bericht slecht ontvangen of moeilijk te begrijpen is en moet worden herhaald'),
                            ],
                          ),
                          TableRow(
                            children: [
                              TableText(text: 'Correct'),
                              TableText(text: 'Uitdrukking om aan te geven dat het ontvangen bericht nauwkeurig overeenstemt met het uitgezonden bericht'),
                            ],
                          ),
                          TableRow(
                            children: [
                          ...
                          TableRow(
                            children: [
                              ...
                              TableText(text: 'U heeft geen toestemming tot... / Stoppen'),
                            ],
                          ),
                          TableRow(
                            children: [
                              TableText(text: 'Herstel'),
                              TableText(text: 'Ik maakte een fout. Ik begin weer bij het laatste uitgesproken woord'),
                            ],
                          ),
                          TableRow(
                            children: [
                              TableText(text: 'Fout (+ ik herhaal)'),
                              TableText(text: 'Uitdrukking om aan te geven dat het ontvangen bericht niet overeenstemt met het uitgezonden bericht'),
                            ],
                          ),
                          TableRow(
                            children: [
                          ...
                          TableRow(
                            children: [
                              ...
                              TableText(text: 'Uitdrukking om de ander te laten wachten'),
                            ],
                          ),
                          TableRow(
                            children: [
                              TableText(text: 'Ik roep u later opnieuw op'),
                              TableText(text: 'Uitdrukking om aan te geven dat de verbinding wordt verbroken, maar later wordt hervat'),
                            ],
                          ),
                          TableRow(
                            children: [
                              TableText(text: 'Aanwijzing ... voorbereiden'),
                              TableText(text: 'Uitdrukking voor de voorbereiding van een toepassing van een procedure (aanwijzing) uit het Formulierenboek'),
                            ],
                          ),
                          TableRow(
                            children: [
                              TableText(text: 'Aanwijzing ... annuleren'),
                              TableText(text: 'Uitdrukking voor het annuleren van een lopende procedure (aanwijzing) uit het Formulierenboek'),
                            ],
                          ),
                          TableRow(
                            children: [
                              TableText(text: 'Ik spel...'),
                              TableText(text: 'Aankondiging dat er gespeld gaat worden (letters en/of cijfers)'),
                            ],
                          ),
                        ],
                      ),
                      ...
                      const BodyText(
                        indents: 2,
                        text: '* De treindienstleider dient bij het uitspreken van trein-, sein- en wisselnummers en bij kilometrages eerst het nummer getal volledig uit te spreken en daarna cijfer voor cijfer;',
                      ),
                      const BodyText(
                        indents: 2,
                        text: '* Bij herhalen van een nummer door de ontvanger is het niet verplicht om dit nummer opnieuw als 1 nummer/getal uit te spreken, het is wel verplicht om dit cijfer voor cijfer uit te spreken.',
                      ),
                      const SizedBoxH(),
                      const BodyText(
                        indents: 1,
                        text: '- 40 Kilometer per uur = Veertig kilometer per uur;',
                      ),
                      const SizedBoxH(),
                      const BodyText(
                        indents: 1,
                      ...
                      const BodyText(
                        indents: 1,
                        text: '- 12 juni 2018 = twaalf-zes-tweeduizendachttien.',
                      ),
                    ],
                  ),
                ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      ...
                      BodyText(
                        indents: 1,
                        text: '- Indien de situatie het vereist dat meerdere bijzonderheden_trein tot stilstand moeten komen, wordt het volgende bericht gebruikt: \'Noodsituatie: stop alle bijzonderheden_trein\';',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
                      ...
                      BoldText(
                        indents: 0,
                        boldtext: 'Berichten bij het beëindigen van werkzaamheden:',
                      ),
                      BodyText(
                        indents: 1,
