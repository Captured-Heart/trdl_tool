...
class AIMondelingeCommunicatie extends StatelessWidget {
  const AIMondelingeCommunicatie({Key? key}) : super(key: key);
                    ...
                    children: const <TableRow>[
                      ...
                      TableRow(
                        children: <TableText>[
                          TableText(text: 'Over'),
                          TableText(
                            text: 'Term om de andere partij het woord te geven',
                          ),
                        ],
                      ),
                      TableRow(
