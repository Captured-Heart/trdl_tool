...
enum WhereToGoFromAICommunicatieSysteem { home_screen, ww_communicatie_main, ai_incidenten_basis,}
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      ...
                      SizedBoxH(),
                      BodyText(indents: 0, text: 'Er zijn meerdere GSM-R cellen binnen een TRDLgebied aanwezig. Dit is voor normale point-to-point oproepen niet van belang, omdat voor de adressering van de juiste TRDL een systeemonderdeel wordt gebruikt dat werkt op basis van treinnummer en PPLG informatie.',),
                      SizedBoxH(),
                      InsertImage(
                        image:
