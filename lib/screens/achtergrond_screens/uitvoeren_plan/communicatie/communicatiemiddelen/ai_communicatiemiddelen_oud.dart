...
class AICommunicatiemiddelenOud extends StatelessWidget {
  const AICommunicatiemiddelenOud({Key? key}) : super(key: key);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: const <Widget>[
          AICommunicatiemiddelenOudNavigation(),
          HomeButton(),
        ],
      ),
      body: SafeArea(
            ...
            children: const <TextCard>[
              TextCard(
                widgetList: <Widget>[
                  SubTitleText(
                    subtitle:
                        'LET OP: Deze achtergrondinformatie is vervallen!',
                  ),
                  SizedBoxH(),
                  NavButton(
                    buttontext: 'AI Communicatiemiddelen NIEUW',
              ...
              TextCard(
                widgetList: <Widget>[
                  TitleText(
                    title: 'Communicatiemiddelen - geldig tot 08-2022',
                  ),
                  SizedBoxH(),
                  SizedBoxH(),
                  BodyText(
...
class AICommunicatiemiddelenOudNavigation extends StatelessWidget {
  const AICommunicatiemiddelenOudNavigation({Key? key}) : super(key: key);
    ...
    return PopupMenuButton<PopupNavigation>(
      ...
      itemBuilder: (BuildContext context) => <PopupMenuEntry<PopupNavigation>>[
        ...
        const PopupMenuItem<PopupNavigation>(
          ...
          child: MenuItemContent(
            icon: IconUtils.iconWW,
            text: 'AI Communicatiemiddelen NIEUW',
          ),
        ),
      ],
    );
