                ...
                child: Column(
                  children: const <Widget>[
                    ...
                    BodyText(
                      indents: 1,
                      text:
                          '- De benodigde elementen moeten beschikbaar zijn;\n\n- De benodigde elementen mogen niet verhinderd zijn;\n\n- De rijweg mag niet voeren naar een spoor op de vrije baan waarover een tegengestelde rijrichting is ingesteld;\n\n- De vrijgave rangeren moet ter beschikking van de TRDL zijn;\n\n- De rijweg mag niet voeren over een vergrendelde inrichting waarvoor de grendel nog niet is teruggegeven en teruggenomen.',
                    ),
                  ],
                ),
              ),
                ...
                child: Column(
                  children: const <Widget>[
                    ...
                    BodyText(
                      indents: 0,
                      text:
                          'Rijwegen worden ingesteld door de TRDL. In procesleiding kan je daarvoor ARI (automatische rijweg instelling) gebruiken.\n\nAls je een rijweg instelt in procesleiding, gebeurt er het volgende:',
                    ),
                    SizedBoxH(),
                    BodyText(
                      indents: 1,
                ...
                child: Column(
                  children: const <Widget>[
                    ...
                    BodyText(
                      indents: 0,
                      text:
                          'Op ieder emplacement zijn er vaste routes die de voorkeur hebben om treinen rijwegen over aan te bieden. Dit komt omdat deze routes een hogere doorrijsnelheid bieden, omdat wissels rechtdoor bereden kunnen worden en/of andere rijwegen mogelijk maken. Hierdoor is de doorstroming op een emplacement te optimaliseren.',
                    ),
                    SizedBoxH(),
                    BoldText(
                      indents: 0,
              ...
              child: Padding(
                ...
                child: Column(
                  children: const <Widget>[
                    ...
                    BoldText(
                      indents: 0,
                      boldtext: 'Herroepen gefaseerde rijweg:',
                    ),
                    BodyText(
                      indents: 1,
                      text:
                    ...
                    BoldText(
                      indents: 0,
                      boldtext: 'Integraal versus Goederencriterium',
                    ),
                    BodyText(
                      indents: 0,
                      text:
                    ...
                    BoldText(
                      indents: 0,
                      boldtext: 'Voorbeeld van de werking',
                    ),
                    BodyText(
                      indents: 0,
                      text:
