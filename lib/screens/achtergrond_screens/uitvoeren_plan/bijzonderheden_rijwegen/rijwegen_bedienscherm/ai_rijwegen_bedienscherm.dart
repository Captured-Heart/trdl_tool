            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: const [
                    TitleText(
                      title: 'Rijwegen - basisinformatie: Rijweg instellen in het bedienscherm',
                    ),
                    SizedBoxH(),
                    SubTitleText(subtitle: 'Instellen van rijwegen vanuit het bedienscherm',),
                    SizedBoxH(),
                    BoldText(indents: 0, boldtext: 'Klik op \'Rijweg\':',),
                    BodyText(
                      indents: 1,
                      text:
                    ...
                    SizedBoxH(),
                    InsertImage(image: 'assets/images/achtergrond_info/uitvoeren_plan/bijzonderheden_rijwegen/rijwegen_bedienscherm/rijwegen_bedienscherm1.png',),
                    SizedBoxH(),
                    BoldText(indents: 0, boldtext: 'Klik op het benodige \'PPLG\':',),
                    BodyText(
                      indents: 1,
                      text:
                    ...
                    SizedBoxH(),
                    BoldText(indents: 0, boldtext: 'Klik op de \'soort rijweg\' die je wil instellen:',),
                    BodyText(
                      indents: 1,
                      text:
                    ...
                    SizedBoxH(),
                    BoldText(indents: 0, boldtext: 'D.m.v. \'Dwang\':',),
                    BodyText(
                      indents: 1,
                      text:
                    ...
                    SizedBoxH(),
                    InsertImage(image: 'assets/images/achtergrond_info/uitvoeren_plan/bijzonderheden_rijwegen/rijwegen_bedienscherm/rijwegen_bedienscherm2.png',),
                    SizedBoxH(),
                    InsertImage(image: 'assets/images/achtergrond_info/uitvoeren_plan/bijzonderheden_rijwegen/rijwegen_bedienscherm/rijwegen_bedienscherm3.png',),
                    SizedBoxH(),
                    BoldText(indents: 0, boldtext: 'Onder \'S\' (Stop) / \'D\' (Door):',),
                    BodyText(indents: 1, text: 'worden invulvlakken actief indien nodig. Voor een rijweginstelling vanaf een sein waarachter overwegen met AKI/AHOB/overpad liggen, moet - waar gevraagd - per overweg worden opgegeven of het om een stop- of doorrijdende trein gaat (elke trein heeft zijn eigen set van stop/door standen).',),
                    SizedBoxH(),
                    BoldText(indents: 0, boldtext: 'Klik indien nodig op \'DT\' (DieselTractie).',),
                    BodyText(indents: 1, text: 'Als er op een spoor geen bovenleiding is en de trein waarvoor je de rijweg wilt instellen heeft dieseltractie, dan selecteer je \'DT\'. Wordt dit vergeten dan zal de instelling mislukken.\n\nN.B.: Check altijd vooraf de tractie van de trein! Het systeem controleert niet of de trein wel geschikt is om op spoor zonder bovenleiding te rijden.',),
                    SizedBoxH(),
                    BoldText(indents: 0, boldtext: 'Klik indien nodig op \'G\' (Goederen criterium).',),
                    BodyText(indents: 1, text: 'Het inrijsein van de tunnel/brug/fly-over (en andere situaties waar L- en H-seinen staan) komt pas uit de stand \'Stop\' als alle seinen tot aan het uitrijsein uit de stand \'Stop\' zijn gekomen. De volledige rijweg kan in een keer worden afgemaakt. Noodzakelijk voor een goederentrein om een tegen een helling op te komen.',),
                    SizedBoxH(),
                    BoldText(indents: 0, boldtext: 'Klik indien nodig op \'E\' (Goederen criterium).',),
                    BodyText(indents: 1, text: 'Wanneer een sein is verhinderd met VHR-E, kan er een rijweg over worden ingesteld als er op \'E\' wordt geklikt. Wordt dit vergeten dan zal de instelling mislukken.\n\nN.B.: \'E\' is niet mogelijk in combinatie met seinbediening \'A\'.',),
                    SizedBoxH(),
                    BoldText(indents: 0, boldtext: 'Let op: je hebt die verhindering voor rijweginstelling niet voor niets geplaatst > wat moet er eerst gebeuren?',),
                    BodyText(indents: 1, text: 'Kies \'Voer in\' of \'Buffer\'. Je kunt nu de planregel direct laten uitvoeren door Procesleiding met \'Voer in\', of in de \'Buffer\' zetten als je deze op een later tijdstip nodig hebt.',),
                  ],
                ),
              ),
            ),
