              ...
              child: Padding(
                ...
                child: Column(
                  children: const [
                    ...
                    SubTitleText(
                      subtitle:
                          'Instellen van rijwegen vanuit het bedienscherm',
                    ),
                    SizedBoxH(),
                    BoldText(
                      indents: 0,
                    ...
                    BoldText(
                      indents: 0,
                      boldtext:
                          'Klik op de \'soort rijweg\' die je wil instellen:',
                    ),
                    BodyText(
                      indents: 1,
                      text:
                    ...
                    BoldText(
                      indents: 0,
                      boldtext:
                          'Klik indien nodig op \'G\' (Goederen criterium).',
                    ),
                    BodyText(
                      indents: 1,
                      text:
                    ...
                    BoldText(
                      indents: 0,
                      boldtext:
                          'Klik indien nodig op \'E\' (Goederen criterium).',
                    ),
                    BodyText(
                      indents: 1,
                      text:
