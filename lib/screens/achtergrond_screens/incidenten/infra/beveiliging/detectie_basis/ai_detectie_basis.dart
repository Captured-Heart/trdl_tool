            ...
            onSelected: (WhereToGoFromAIDetectie result) async {
              if (result == WhereToGoFromAIDetectie.home_screen) {
                await Navigator.pushNamed(context, 'home_screen');
                  ...
                  WhereToGoFromAIDetectie.ww_reset_assenteller) {
                await Navigator.pushNamed(context, 'ww_reset_assenteller');
              } else if (result ==
                  WhereToGoFromAIDetectie.ai_beveiliging_basis1) {
                await Navigator.pushNamed(context, 'ai_beveiliging_basis1');
              } else if (result ==
                  WhereToGoFromAIDetectie.ai_beveiliging_basis2) {
                await Navigator.pushNamed(context, 'ai_beveiliging_basis2');
              } else if (result == WhereToGoFromAIDetectie.ai_roestvorming) {
