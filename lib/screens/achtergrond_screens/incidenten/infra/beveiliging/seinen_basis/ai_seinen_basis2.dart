              ...
              child: Padding(
                ...
                child: Column(
                  children: const <Widget>[
                    ...
                    SizedBoxH(),
                    BoldText(indents: 0, boldtext: 'Op een seinbeeldenkaart kun je controleren of het seinbeeld dat de MCN heeft gezien door het betreffende sein kan worden getoond. Je gebruikt de seinbeeldenkaart als volgt:',),
                    BodyText(indents: 1, text: '- Zoek de seinbeeldenkaart voor de juiste rijrichting. Let daarbij op het symbool rechtsonder;',),
                    InsertImage: (image: 'assets/images/achtergrond_info/incidenten/ai_seinen_basis2_8.png',),
                    BodyText(indents: 1, text: '- Zoek het sein op waarvan je het seinbeeld wilt weten;',),
                    BodyText(indents: 1, text: '- Volg de lijn vanaf dat getoonde seinbeeld terug naar het sein daarvoor',),
                    SizedBoxH(),
                    BoldText(indents: 0, boldtext: 'Voorbeelden',),
                    SizedBoxH(),
                    InsertImage(image: 'assets/images/achtergrond_info/incidenten/ai_seinen_basis2_9.png',),
                    BodyText(indents: 0, text: 'Als sein 104 geel toont, dan toont sein 108 geel.',),
                    SizedBoxH(),
                    InsertImage(image: 'assets/images/achtergrond_info/incidenten/ai_seinen_basis2_10.png',),
                    BodyText(indents: 0, text: 'Als sein 104 ROZ toont dan toont sein 110 geel.',),
                    SizedBoxH(),
                    BodyText(indents: 0, text: 'Kom je bij een afslaande lijn dan mag je die volgen. Bij een kruisende lijn mag je alleen de afslaande lijn volgen als in de hoek die de lijnen met elkaar maken, een teken is aangebracht.',),
                    InsertImage(image: 'assets/images/achtergrond_info/incidenten/ai_seinen_basis2_11.png',),
                    BodyText(indents: 0, text: 'Je kunt het seinbeeld lezen van:',),
                    BodyText(indents: 1, text: '- A naar B;\n- A naar C;\n- A naar G.',),
                    InsertImage(image: 'assets/images/achtergrond_info/incidenten/ai_seinen_basis2_12.png',),
                    BodyText(indents: 0, text: 'Je kunt het seinbeeld NIET lezen van:',),
                    BodyText(indents: 1, text: '- A naar D;\n- A naar E;\n- A naar F.',),
                    SizedBoxH(),
                    BoldText(indents: 0, boldtext: 'Symbolen die voorkomen op OS-bladen',),
                    SizedBoxH(),
                    InsertImage(image: 'assets/images/achtergrond_info/incidenten/ai_seinen_basis2_13.png',),
                    InsertImage(image: 'assets/images/achtergrond_info/incidenten/ai_seinen_basis2_14.png',),
                    InsertImage(image: 'assets/images/achtergrond_info/incidenten/ai_seinen_basis2_15.png',),
                    InsertImage(image: 'assets/images/achtergrond_info/incidenten/ai_seinen_basis2_16.png',),
                    BodyText(indents: 0, text: 'N.B.: Bij de getekende wissels is de verhouding 1:9, indien de verhouding anders is wordt dit aangegeven in de scherpe hoek.',),
                  ],
                ),
              ),
            ),
