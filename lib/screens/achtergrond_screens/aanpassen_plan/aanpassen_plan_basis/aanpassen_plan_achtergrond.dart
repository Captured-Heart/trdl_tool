                  ...
                  child: Column(
                    children: const [
                      ...
                      BodyText(
                        indents: 0,
                        text:
                            'Bij aanpassing van rijwegen voor rangeerbewegingen, schouwtreinen en meetritten, ben je verplicht -voordat je de rijweg instelt- de machinist of de medewerker rangeren in te lichten over de aanpassing.',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
                        text:
                            'Als je een spoorwijziging initieert naar een korter (perron)spoor dan het geplande (perron)spoor, vraag je de machinist of de medewerker rangeren naar de lengte van de trein.',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
                      ...
                      BodyText(
                        indents: 0,
                        text:
                            'Wanneer blijkt dat een reizigerstrein niet in zijn geheel langs het perron past en er géén ander geschikt perronspoor beschikbaar is, communiceer je dit met de machinist of de medewerker rangeren en stemt af of de spoorwijziging toch kan worden doorgevoerd.',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
                  ...
                  child: Column(
                    children: const [
                      ...
                      BodyText(
                        indents: 0,
                        text:
                            'Bij evenementen kan er, op last van de overheidshulpdiensten in het kader van crowdcontrol of dreigende openbare ordeproblemen, de opdracht komen om een trein eerder, later of meteen te laten vertrekken. Je kunt hierbij denken aan bijv. treinen met voetbalsupporters of demonstranten die de politie gecontroleerd wil laten vertrekken om escalatie te voorkomen.',
                      ),
                      SizedBoxH(),
                      BoldText(
                  ...
                  child: Column(
                    children: [
                      ...
                      const BodyText(
                        indents: 0,
                        text:
                            'Treinen hebben een nummer en rijden in series (treinseries). Alle treinen hebben een uniek nummer dat maar 1 keer per dag mag voorkomen. Serienummers zijn niet uniek. Zij geven aan van waarnaar waar een trein rijdt.',
                      ),
                      const SizedBoxH(),
                      const BodyText(
                        indents: 0,
                      ...
                      const BodyText(
                        indents: 0,
                        text:
                            'Omdat corridor treinen over lange afstanden rijden is het noodzakelijk dat deze treinen goed in de gaten gehouden worden. Wanneer er binnen jouw treindienstleidersgebied iets met een dergelijke trein gebeurt zal dat gevolgen (kunnen) hebben voor het verdere traject.',
                      ),
                      const SizedBoxH(),
                      const BodyText(
                        indents: 0,
