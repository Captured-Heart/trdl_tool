              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      CardTitle(
                        title: 'Afhandelen LOA reizigersvervoer',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      CardTitle(
                        title: 'Afhandelen LOA goederenvervoer',
                      ),
                      BodyText(
                        indents: 0,
                        text:
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      CardTitle(
                        title: 'Bovenlokale Orderaanvragen',
                      ),
                      BodyText(
                        indents: 0,
                        text:
                            'Bovenlokale orderaanvragen worden ingediend bij de verkeersleider (DVL). De DVL toetst deze concept dienstregeling vooraf bij de TRDL (o.a. op lokale verdringing). Om deze toets juist te kunnen uitvoeren, moet de TRDL op de hoogte zijn van de voor hem relevante gegevens. Wat moet de TRDL weten:',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 1,
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      CardTitle(
                        title: 'Besturings- en/of planningsnormen',
                      ),
                      BodyText(
                        indents: 0,
                        text:
