...
TextCard(
            ...
            TextCard(
                  widgetList: const <Widget>[
                    ...
                    BodyText(
                      indents: 0,
                      text: 'De technisch minimale norm voor halterende goederentreinen is 2 minuten. Voor reizigerstreinen geldt een minimale norm van < 1 minuut, in de planning (is korte stop +).',
                    ),
                    SizedBoxH(),
                    BoldText(
                      indents: 0,
...
class AIOrderAcceptatieNavigation extends StatelessWidget {
  const AIOrderAcceptatieNavigation({Key? key}) : super(key: key);
