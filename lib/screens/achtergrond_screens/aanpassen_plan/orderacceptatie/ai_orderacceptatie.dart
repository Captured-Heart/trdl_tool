              ...
              TextCard(
                widgetList: <Widget>[
                  ...
                  BodyText(
                    indents: 0,
                    text:
                        'De technisch minimale norm voor halterende goederentreinen is 2 minuten. Voor reizigerstreinen geldt een minimale norm van < 1 minuut, in de planning (is korte stop +).',
                  ),
                  SizedBoxH(),
                  BoldText(
                    indents: 0,
