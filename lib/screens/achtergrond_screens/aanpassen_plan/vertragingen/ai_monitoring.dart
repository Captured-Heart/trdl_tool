            ...
            onSelected: (WhereToGoFromAIMonitoring result) {
              if (result == WhereToGoFromAIMonitoring.home_screen) {
                Navigator.pushNamed(context, 'home_screen');
                  ...
                  WhereToGoFromAIMonitoring.ww_vertragingen) {
                Navigator.pushNamed(context, 'ww_vertragingen');
              } else if (result ==
                  WhereToGoFromAIMonitoring.ai_vertragingen) {
                Navigator.pushNamed(context, 'ai_vertragingen');
              } else if (result ==
                  WhereToGoFromAIMonitoring.ai_klanthinder) {
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      ...
                      SizedBoxH(),
                      BodyText(indents: 1, text: '- Vertraging;\n\n- Planaanpassingen;\n\n- Veiligheidsrisico\'s.',),
                    ],
                  ),
                ),
              ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      ...
                      SizedBoxH(),
                      InsertImage(image: 'assets/images/achtergrond_info/aanpassen_plan/vertragingen/ai_monitoring_1.jpg',),
                      SizedBoxH(),
                    ],
                  ),
                ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      SubTitleText(
                        subtitle:
                            'Wat verklaren we in Monitoring?',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      ...
                      BodyText(
                        indents: 0,
                        text: 'Moet je een vertraging verklaren? Dan geldt nog steeds: probeer zo goed mogelijk de oorzaak te verklaren en deze kort in het \'opmerkingen-veld\' in Monitoring te beschrijven. Dit helpt om goede analyses te maken. Op basis van deze input kan het Prestatie Analyse Bureau verdere verbeteringen voorstellen.',
                      ),
                      SizedBoxH(),
                      BoldText(
                        indents: 0,
                      ...
                      SizedBoxH(),
                      InsertImage(image: 'assets/images/achtergrond_info/aanpassen_plan/vertragingen/ai_monitoring_3.jpg',),
                      BodyText(
                        indents: 0,
                        text:
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      ...
                      SizedBoxH(),
                      BodyText(indents: 0, text: 'Daarnaast wordt ook een veiligheidsrisico zonder TVTA\'s geregistreerd. Het afhandelen van een incident i.c.m. het afgeven van een aanwijzing leidt overigens altijd tot een registratie in Monitoring met veiligheidsrisico \'ja\'. Zelfs dus als er geen TVTA\'s gegenereerd zijn.',),
                      SizedBoxH(),
                      BoldText(
                        indents: 0,
