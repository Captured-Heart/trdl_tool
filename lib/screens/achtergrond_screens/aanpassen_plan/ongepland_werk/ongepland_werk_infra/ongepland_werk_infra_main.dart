                  ...
                  child: Column(
                    children: const [
                      ...
                      BodyText(
                        indents: 1,
                        text:
                            '- Storingsgebied kan bereden worden en herstel heeft urgent karakter vanwege impact op veiligheid, logistiek en/of werkbelasting treindienstleider: storingsherstel met tijdsafspraak;',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 1,
                  ...
                  child: Column(
                    children: const [
                      ...
                      BodyText(
                        indents: 1,
                        text:
                            'Als er geen (maatwerk) storingsWBI/WECO is, maar wel een RVO-nummer (Rapport van Onregelmatigheid) dan kun je samen met de LWB samen een WECO opstellen. De werkzaamheden vinden dan plaatst onder een RVO-nummer. Dit mag alleen in een geval van een (dreigende) storing/onregelmatigheid.',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
