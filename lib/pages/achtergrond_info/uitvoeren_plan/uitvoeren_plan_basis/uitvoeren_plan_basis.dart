                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      ...
                      BodyText(
                        indents: 1,
                        text: 'ProRail en vervoerders stellen samen het ‘basisuurpatroon’ op. Daarin leggen we vast hoeveel bijzonderheden_trein er per uur kunnen rijden op een bepaald traject en in welke frequentie. In deze fase worden de grootste knelpunten vast geïnventariseerd;',
                      ),
                      BoldText(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      ...
                      SizedBoxH(),
                      CardTitle(
                        title: 'Planaanpassing bij incidenten',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      CardTitle(
                        title: 'Werkplekinformatie - Bedienvoorschriften (BVS) en bovenleiding schema\'s',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
                      ...
                      SizedBoxH(),
                      CardTitle(
                        title: 'Tekeningen signaleringsbeelden',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
                      ...
                      SizedBoxH(),
                      CardTitle(
                        title: 'Baanvak en emplacementstekeningen',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
                      ...
                      SizedBoxH(),
                      InsertImage(
                        image: 'assets/images/achtergrond_info/uitvoeren_plan/uitvoeren_plan_basis/bvsTekening.png',
                      ),
                      SizedBoxH(),
                      CardTitle(
                        title: 'OS-bladen (overzicht seinen)',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
                      ...
                      SizedBoxH(),
                      InsertImage(
                        image: 'assets/images/achtergrond_info/uitvoeren_plan/uitvoeren_plan_basis/osBlad.png',
                      ),
                      SizedBoxH(),
                      CardTitle(
                        title: 'Bovenleiding schema\'s',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
                      ...
                      SizedBoxH(),
                      InsertImage(
                        image: 'assets/images/achtergrond_info/uitvoeren_plan/uitvoeren_plan_basis/bovenleidingSchema.png',
                      ),
                      SizedBoxH(),
                    ],
                  ),
