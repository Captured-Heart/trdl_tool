                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      ...
                      SizedBoxH(),
                      CardTitle(
                        title: 'Toelating (werk)trein tot buitendienst gesteld gebied',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
                      ...
                      BodyText(
                        indents: 1,
                        text: '- alleen de LWB de werktrein mag toelaten tot buitendienst gestelde sporen;',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 1,
                        text: '- alleen jij de werktrein mag toelaten op in dienst zijnde sporen.',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: const [
                      CardTitle(
                        title: 'Toelating (werk)trein tot in dienst gesteld gebied',
                      ),
                      SizedBoxH(),
                      BodyText(
                        indents: 0,
