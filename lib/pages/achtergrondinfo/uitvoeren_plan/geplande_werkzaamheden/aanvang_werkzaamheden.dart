                    ...
                    children: [
                      ...
                      Row(
                        children: const [
                          ...
                          Expanded(
                            child: BodyText(
                              text: '- Vraag goed uit hoe lang de uitloop gaat zijn.',
                      ...
                      Row(
                        children: const [
                          ...
                          Expanded(
                            child: BodyText(
                              text: '- Neem maatregelen om onveilige situaties te voorkomen.',
                              style: TextStyle(fontWeight: FontWeight.bold,),
                            ),
                          ),
                        ],
                      ...
                      Row(
                        children: const [
                          ...
                          Expanded(
                            child: BodyText(
                              text: '- Meld de uitloop van de werkzaamheden aan de DVL en de OvD-V.',
                              style: TextStyle(fontWeight: FontWeight.bold,),
                            ),
                          ),
                        ],
                      ...
                      Row(
                        children: const [
                          ...
                          Expanded(
                            child: BodyText(
                              text: '- Meld de uitloop van de werkzaamheden aan de Meldkamer spoor/ Backoffice.',
                              style: TextStyle(fontWeight: FontWeight.bold,),
                            ),
                          ),
                        ],
