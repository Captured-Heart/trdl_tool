...
Map<String, WidgetBuilder> customRoutes = <String, WidgetBuilder>{
  ...
  'ww_bovenleiding_ruclu': (BuildContext context) => const WWProcedureRuClu(),
  'ww_bovenleiding_schakelen': (BuildContext context) =>
      const WWSchakelenBovenleiding(),
  'ww_bovenleiding_schouwen': (BuildContext context) =>
      const WWSchouwenBovenleiding(),
  'ww_kunstwerken_main': (BuildContext context) => const WWKunstwerkenMain(),
  'ww_kunstwerken_aanrijding': (BuildContext context) =>
      const WWAanrijdingViaduct(),
  'ww_kunstwerken_storing': (BuildContext context) => const WWStoringBrug(),
  ...
  'ww_wissel_opengereden': (BuildContext context) =>
      const WWOpengeredenWissel(),
  'ww_wissel_gestoord': (BuildContext context) => const WWGestoordWissel(),
  'ww_wissel_beschadigd': (BuildContext context) => const WWBeschadigdWissel(),
  ...
  'ai_mensen_dieren_voorwerpen_main': (BuildContext context) =>
      const AIMensenDierenVoorwerpenMain(),
